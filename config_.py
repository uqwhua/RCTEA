...
class cfg():
    ...
    def get_args(self):
        ...
        # --------- MEAformer -----------
        parser.add_argument("--hidden_size", type=int, default=150, help="the hidden size of MEAformer")
        parser.add_argument("--intermediate_size", type=int, default=200, help="the hidden size of MEAformer")
        ...
        self.cfg = parser.parse_known_args()[0]
